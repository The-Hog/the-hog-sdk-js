...
export class ClientSDK {
  ...
  constructor(options: SDKOptions = {}) {
    if (options.security == null && (options.accessKey != null || options.secretKey != null)) {
      const security: { accessKey?: string; secretKey?: string } = {};
      if (options.accessKey != null) security.accessKey = options.accessKey;
      if (options.secretKey != null) security.secretKey = options.secretKey;
      options = {
        ...options,
        security,
      };
    ...
    if (!this.#logger && env().THE_HOG_DEBUG) {
      this.#logger = console;
    }
  }
